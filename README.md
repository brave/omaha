...
## Update
04/10/2023: Don't apply commit: `aefae2f: Add support for Arm64 Windows` because there are errors relating to ARM64 platform when create_dist Herond Browser on the Windows environment - Windows does not support preprocessor definition of ARM64