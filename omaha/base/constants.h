...
// *** UI constants.                              ***
// ***                                            ***
const COLORREF kTextColor = RGB(0x40, 0x47, 0x4F);
...
const COLORREF kProgressEmptyFillColor = RGB(0xe7, 0xe7, 0xe7);
const COLORREF kProgressEmptyFrameColor = RGB(0xe7, 0xe7, 0xe7);
