...
const TCHAR kExpectedUrlForTestAppAndNoOmahaValues[] = _T("https://updates.bravesoftware.com/service/check2&appid=%7B8E472B0D-3E8B-43b1-B89A-E8506AAF1F16%7D&appversion=3.4.5.6&applang=en-us&machine=1&version=0.0.0.0&userid=&osversion=");  // NOLINT
